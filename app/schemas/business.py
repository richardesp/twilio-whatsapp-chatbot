...
class Service(BaseModel):
    ...
    service_duration_minutes: int = Field(
        default=..., ge=0, description="Duration of the service in minutes.", example=30
    )
...
class Business(BaseModel):
    ...
    phone_number: PhoneNumber = Field(
        ...,
        description="Whatsapp phone number associated with the business (has to be unique).",
        example="whatsapp:+12345678912",
    )
